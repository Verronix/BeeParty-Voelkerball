package src.main.java.net.beeparty.voelkerball.commands;
...
import src.main.java.net.beeparty.voelkerball.manager.DataManager;
...
public class CMD_Voelkerball implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(!(sender instanceof Player))
            System.out.println("Diesen Befehl darf nur ein Spieler ausführen!");
